...
author: "Basado en el material de Juan Barriola, Fernando González y Franco Mastelli"
lang: es
format:
  html:
    theme:  flatly
...
Cualquier consulta sobre esta clase, GLM y Regresión Logística y Regularización, consultar al siguiente mail:

pamepairo@gmail.com

## Breve Repaso y hacia donde vamos 🚀

![](img/repaso_1.png){width=800}
![](img/repaso_2.png){width=800}

# ¿Qué es [Tidyverse](https://www.tidyverse.org/)?        

![](img/tidyverse.png){fig-align="center" width=100}

Es un paquete “umbrella” que agrupa una serie de paquetes que tienen una
misma lógica.

![](img/paquetes.png){fig-align="center"}
...
library(tidyverse)
```
A lo largo de esta clase usaremos parte de un conjunto de datos real del [Indice de salarios del INDEC](https://www.indec.gob.ar/indec/web/Nivel4-Tema-4-31-61).
...
![](img/dplyr.png){fig-align="center" width=100}

El caracter principal para utilizar este paquete es ```%>%``` o ```|>```, _pipe_ (de tubería).
...
![https://tavareshugo.github.io/r-intro-tidyverse-gapminder/08-joins/index.html](https://tavareshugo.github.io/r-intro-tidyverse-gapminder/fig/07-dplyr_joins.svg){width=500}        
...
# especificamos la variable que será utilizada para unir ambas tablas con "by"
  left_join(., Ponderadores, 
            by = join_by("GRUPO"=="GRUPO"))
Datos_join
...
![](img/tidyr.png){fig-align="center" width=100}
...
![](img/pivot.png){fig-align="center" width=600}
...
![](img/lubridate.png){fig-align="center" width=100}
...
![](img/stringr.png){fig-align="center" width=100}
