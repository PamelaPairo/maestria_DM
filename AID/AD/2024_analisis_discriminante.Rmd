...
```{r}
setosa<- subset(df_train[,2:5], df_train$species == "Adelie")
versicolor<- subset(df_train[,2:5], df_train$species == "Gentoo")
virginica <- subset(df_train[,2:5], df_train$species=="Chinstrap")
```
...
$\ LD1= 0.78*Sepal.Length+ 1.79*Sepal.Width - 2.13*Petal.Length -3.03*Petal.Width$
