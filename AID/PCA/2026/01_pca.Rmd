...
- Cada coeficiente mide la contribución de una dada variable a un dado componente.

- Si las variables están medidas en la misma escala o los datos fueron estandarizados, representan la contribución relativa de cada variable.
...
A partir de los datos obtenidos de un estudio sobre las preferencias de vinos en Portugal, se realizó un PCA y a continuación se muestra el biplot del mismo. Para mas detalles del estudio ver el siguiente [link](https://sci-hub.hlgczx.com/10.1016/j.dss.2009.05.016). Interprete el biplot.
...
La primer componente diferencia a los vinos tintos de los vinos blancos especialmente referido a los minerales que posee y los sulfitos (estructura del vino)

La segunda componente parece captar la variabilidad relacionada con los años en barrica (mayor acidez y alcohol). PC2 captura diferencias en el proceso de fermentación y perfil aromático
